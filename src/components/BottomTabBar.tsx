      ...
      <div className="flex h-full max-w-md mx-auto relative">
        ...
        <button
          ...
          className={`
            ...
            ${activeTab === tabs[0].id ? 'text-primary' : 'text-text-muted hover:text-text-secondary'}
          `}
        >
        ...
        <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2">
          <button
            ...
            className="w-14 h-14 bg-primary text-white rounded-full shadow-fab flex items-center justify-center hover:scale-105 active:scale-95 transition-all duration-200"
          >
        ...
        <button
          ...
          className={`
            flex-1 flex flex-col items-center justify-center gap-1 py-2
            transition-colors duration-200
            ${activeTab === tabs[1].id ? 'text-primary' : 'text-text-muted hover:text-text-secondary'}
          `}
        >
